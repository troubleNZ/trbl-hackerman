...
***This is for qbcore versions pre August 2022, as it still uses the `'QBCore:HasItem', function(result)` callback.***
...
ie boosting laptop stuff from a carboosting script, and vpn software for hacking the things.
